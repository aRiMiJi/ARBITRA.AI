        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((step, index) => (
            ...
            >
              ...
              <div className="hidden lg:block absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-4 w-4 bg-brand-dark border-2 border-brand-cyan rounded-full"></div>
              
              <Card>
                <div className="text-6xl font-black font-sans text-brand-cyan/30 mb-4">{step.step}</div>
